...
class NewsAndBlogsController {
    ...
    async FetchNewsAndBlogs(req, res, next) {
        try {
    ...
    async FetchNewsAndBlogsById(req, res, next) {
        try {
            const { _id } = req.body;
    ...
    async SearchNewsAndBlogs(req, res, next) {
        try {
    ...
    async filterNewsAndBlogs(req, res, next) {
        try {
    ...
    async NewsAndBlogsLike(req, res, next) {
        try {
    ...
    async NewsAndBlogsDislike(req, res, next) {
        try {
            const { BlogId, userId } = req.body;
